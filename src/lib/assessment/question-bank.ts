...
export const INTEREST_BANK: InterestQ[] = [
  {
    ...
    options: [
      { id: "s1_square",    label: "Square",    visual: { kind: "icon", icon: "square" },    riasec: { C: 3, R: 1 } },
      { id: "s1_triangle",  label: "Triangle",  visual: { kind: "icon", icon: "triangle" },  riasec: { E: 3 } },
      { id: "s1_circle",    label: "Circle",    visual: { kind: "icon", icon: "circle" },    riasec: { S: 3 } },
      { id: "s1_squiggle",  label: "Squiggle",  visual: { kind: "icon", icon: "squiggle" },  riasec: { A: 3 } },
      { id: "s1_rectangle", label: "Rectangle", visual: { kind: "icon", icon: "rectangle" }, riasec: { I: 2, S: 1 } },
      { id: "s1_diamond",   label: "Diamond",   visual: { kind: "icon", icon: "diamond" },   riasec: { E: 1, C: 2 } },
    ],
  },
  {
    ...
    options: [
      { id: "a1_lion",    label: "Lion",    visual: { kind: "icon", icon: "lion" }, riasec: { E: 3, R: 1 } },
      { id: "a1_owl",     label: "Owl",     visual: { kind: "icon", icon: "owl" }, riasec: { I: 3 } },
      { id: "a1_dolphin", label: "Dolphin", visual: { kind: "icon", icon: "dolphin" }, riasec: { S: 3, A: 1 } },
      { id: "a1_eagle",   label: "Eagle",   visual: { kind: "icon", icon: "eagle" }, riasec: { E: 2, I: 2 } },
      { id: "a1_fox",     label: "Fox",     visual: { kind: "icon", icon: "fox" }, riasec: { A: 2, E: 2 } },
      { id: "a1_wolf",    label: "Wolf",    visual: { kind: "icon", icon: "wolf" }, riasec: { R: 2, S: 2 } },
    ],
  },
  {
    ...
    options: [
      { id: "l1_straight", label: "Straight",   visual: { kind: "icon", icon: "l_straight" }, riasec: { C: 3 } },
      { id: "l1_diagonal", label: "Rising",     visual: { kind: "icon", icon: "l_diagonal" }, riasec: { E: 3 } },
      { id: "l1_wave",     label: "Wave",       visual: { kind: "icon", icon: "l_wave" },     riasec: { A: 3 } },
      { id: "l1_zigzag",   label: "Zig-zag",    visual: { kind: "icon", icon: "l_zigzag" },   riasec: { E: 2, R: 1 } },
      { id: "l1_spiral",   label: "Spiral",     visual: { kind: "icon", icon: "l_spiral" },   riasec: { I: 3 } },
      { id: "l1_grid",     label: "Grid",       visual: { kind: "icon", icon: "l_grid" },     riasec: { I: 2, C: 2 } },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: "n1_mountain", label: "Mountain peak", visual: { kind: "icon", icon: "mountain" }, riasec: { E: 2, R: 2 } },
      { id: "n1_ocean",    label: "Open ocean",    visual: { kind: "icon", icon: "ocean" }, riasec: { I: 2, A: 2 } },
      { id: "n1_forest",   label: "Deep forest",   visual: { kind: "icon", icon: "forest" }, riasec: { R: 2, I: 1, S: 1 } },
      { id: "n1_city",     label: "City lights",   visual: { kind: "icon", icon: "city" }, riasec: { E: 2, C: 1 } },
      { id: "n1_meadow",   label: "Golden field",  visual: { kind: "icon", icon: "meadow" }, riasec: { S: 2, A: 1 } },
      { id: "n1_desert",   label: "Quiet desert",  visual: { kind: "icon", icon: "desert" }, riasec: { I: 2, R: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "p1_dots",      label: "Ordered dots",  visual: { kind: "icon", icon: "p_dots" },      riasec: { C: 2, I: 1 } },
      { id: "p1_geometric", label: "Geometric",     visual: { kind: "icon", icon: "p_geometric" }, riasec: { I: 2, C: 1 } },
      { id: "p1_organic",   label: "Organic flow",  visual: { kind: "icon", icon: "p_organic" },   riasec: { A: 2, S: 1 } },
      { id: "p1_circuit",   label: "Circuitry",     visual: { kind: "icon", icon: "p_circuit" },   riasec: { I: 2, R: 1 } },
      { id: "p1_marble",    label: "Marble veins",  visual: { kind: "icon", icon: "p_marble" },    riasec: { A: 2, R: 1 } },
      { id: "p1_doodle",    label: "Free doodle",   visual: { kind: "icon", icon: "p_doodle" },    riasec: { A: 3 } },
    ],
  },
  {
    ...
    options: [
      { id: "e1_fire",      label: "Fire",      visual: { kind: "icon", icon: "fire" }, riasec: { E: 3 } },
      { id: "e1_water",     label: "Water",     visual: { kind: "icon", icon: "water" }, riasec: { S: 2, A: 1 } },
      { id: "e1_earth",     label: "Earth",     visual: { kind: "icon", icon: "earth" }, riasec: { R: 2, C: 1 } },
      { id: "e1_air",       label: "Air",       visual: { kind: "icon", icon: "air" }, riasec: { A: 2, I: 1 } },
      { id: "e1_lightning", label: "Lightning", visual: { kind: "icon", icon: "lightning" }, riasec: { E: 2, I: 1 } },
      { id: "e1_crystal",   label: "Crystal",   visual: { kind: "icon", icon: "crystal" }, riasec: { C: 2, I: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "o1_compass",   label: "Compass",     visual: { kind: "icon", icon: "compass" }, riasec: { E: 2, R: 1 } },
      { id: "o1_book",      label: "Book",        visual: { kind: "icon", icon: "book" }, riasec: { I: 3 } },
      { id: "o1_brush",     label: "Paintbrush",  visual: { kind: "icon", icon: "brush" }, riasec: { A: 3 } },
      { id: "o1_magnifier", label: "Magnifier",   visual: { kind: "icon", icon: "magnifier" }, riasec: { I: 3 } },
      { id: "o1_megaphone", label: "Megaphone",   visual: { kind: "icon", icon: "megaphone" }, riasec: { E: 2, S: 1 } },
      { id: "o1_wrench",    label: "Wrench",      visual: { kind: "icon", icon: "wrench" }, riasec: { R: 3 } },
    ],
  },
  {
    ...
    options: [
      { id: "d1_drum",   label: "Steady drum",  visual: { kind: "icon", icon: "drum" }, riasec: { C: 2, R: 1 } },
      { id: "d1_sax",    label: "Jazz sax",     visual: { kind: "icon", icon: "sax" }, riasec: { A: 3 } },
      { id: "d1_violin", label: "Violin",       visual: { kind: "icon", icon: "violin" }, riasec: { S: 2, A: 1 } },
      { id: "d1_synth",  label: "Electronic",   visual: { kind: "icon", icon: "headphones" }, riasec: { I: 2, A: 1 } },
      { id: "d1_guitar", label: "Electric guitar", visual: { kind: "icon", icon: "guitar" }, riasec: { E: 2, A: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "s2_star",      label: "Star",       visual: { kind: "icon", icon: "star" },      riasec: { E: 2, A: 1 } },
      { id: "s2_hexagon",   label: "Hexagon",    visual: { kind: "icon", icon: "hexagon" },   riasec: { I: 2, R: 1 } },
      { id: "s2_circle",    label: "Circle",     visual: { kind: "icon", icon: "circle" },    riasec: { S: 3 } },
      { id: "s2_square",    label: "Square",     visual: { kind: "icon", icon: "square" },    riasec: { C: 3 } },
      { id: "s2_diamond",   label: "Diamond",    visual: { kind: "icon", icon: "diamond" },   riasec: { E: 1, C: 2 } },
      { id: "s2_squiggle",  label: "Squiggle",   visual: { kind: "icon", icon: "squiggle" },  riasec: { A: 3 } },
    ],
  },
  {
    ...
    options: [
      { id: "a2_bee",       label: "Bee",       visual: { kind: "icon", icon: "bee" }, riasec: { C: 2, R: 1 } },
      { id: "a2_turtle",    label: "Turtle",    visual: { kind: "icon", icon: "turtle" }, riasec: { C: 1, R: 1, I: 1 } },
      { id: "a2_butterfly", label: "Butterfly", visual: { kind: "icon", icon: "butterfly" }, riasec: { A: 2, S: 1 } },
      { id: "a2_elephant",  label: "Elephant",  visual: { kind: "icon", icon: "elephant" }, riasec: { S: 2, C: 1 } },
      { id: "a2_horse",     label: "Horse",     visual: { kind: "icon", icon: "horse" }, riasec: { R: 2, E: 1 } },
      { id: "a2_octopus",   label: "Octopus",   visual: { kind: "icon", icon: "octopus" }, riasec: { I: 2, A: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "l2_straight", label: "Two rails",    visual: { kind: "icon", icon: "l_straight" }, riasec: { C: 2, R: 1 } },
      { id: "l2_diagonal", label: "Climbing",     visual: { kind: "icon", icon: "l_diagonal" }, riasec: { E: 2, C: 1 } },
      { id: "l2_wave",     label: "Ribbon",       visual: { kind: "icon", icon: "l_wave" },     riasec: { A: 3 } },
      { id: "l2_zigzag",   label: "Sharp turns",  visual: { kind: "icon", icon: "l_zigzag" },   riasec: { E: 2, R: 1 } },
      { id: "l2_spiral",   label: "Inward loop",  visual: { kind: "icon", icon: "l_spiral" },   riasec: { I: 3 } },
      { id: "l2_grid",     label: "Network",      visual: { kind: "icon", icon: "l_grid" },     riasec: { I: 1, E: 1, C: 1 } },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: "n2_stars",   label: "Starry sky",     visual: { kind: "icon", icon: "stars" }, riasec: { I: 2, A: 1 } },
      { id: "n2_farm",    label: "Rolling farmland",visual: { kind: "icon", icon: "farm" }, riasec: { R: 2, C: 1 } },
      { id: "n2_harbor",  label: "Busy harbour",   visual: { kind: "icon", icon: "harbor" }, riasec: { E: 2, R: 1 } },
      { id: "n2_loft",    label: "Art-filled loft",visual: { kind: "icon", icon: "loft" }, riasec: { A: 3 } },
      { id: "n2_trail",   label: "Mountain trail",  visual: { kind: "icon", icon: "trail" }, riasec: { R: 2, E: 1 } },
      { id: "n2_library", label: "Quiet library",  visual: { kind: "icon", icon: "library" }, riasec: { I: 2, S: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "o2_telescope", label: "Telescope", visual: { kind: "icon", icon: "telescope" }, riasec: { I: 3 } },
      { id: "o2_camera",    label: "Camera",    visual: { kind: "icon", icon: "camera" }, riasec: { A: 2, I: 1 } },
      { id: "o2_toolbox",   label: "Toolbox",   visual: { kind: "icon", icon: "toolbox" }, riasec: { R: 3 } },
      { id: "o2_abacus",    label: "Abacus",    visual: { kind: "icon", icon: "abacus" }, riasec: { C: 3 } },
      { id: "o2_mic",       label: "Microphone",visual: { kind: "icon", icon: "mic" }, riasec: { E: 2, S: 1 } },
      { id: "o2_map",       label: "Map",       visual: { kind: "icon", icon: "map" }, riasec: { I: 1, E: 1, R: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "g1_chess",  label: "Chess",         visual: { kind: "icon", icon: "chess" }, riasec: { I: 2, E: 1 } },
      { id: "g1_jigsaw", label: "Jigsaw puzzle", visual: { kind: "icon", icon: "jigsaw" }, riasec: { C: 2, I: 1 } },
      { id: "g1_improv", label: "Improv / charades", visual: { kind: "icon", icon: "masks" }, riasec: { A: 2, S: 1 } },
      { id: "g1_relay",  label: "Team relay",    visual: { kind: "icon", icon: "runner" }, riasec: { R: 2, S: 1 } },
      { id: "g1_cards",  label: "Card bluffing", visual: { kind: "icon", icon: "cards" }, riasec: { E: 2, C: 1 } },
      { id: "g1_blocks", label: "Building blocks", visual: { kind: "icon", icon: "blocks" }, riasec: { R: 2, A: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "m1_clay",   label: "Clay",   visual: { kind: "icon", icon: "clay" }, riasec: { A: 2, R: 1 } },
      { id: "m1_steel",  label: "Steel",  visual: { kind: "icon", icon: "steel" }, riasec: { R: 2, E: 1 } },
      { id: "m1_glass",  label: "Glass",  visual: { kind: "icon", icon: "glass" }, riasec: { A: 1, C: 1, I: 1 } },
      { id: "m1_wood",   label: "Wood",   visual: { kind: "icon", icon: "wood" }, riasec: { R: 2, C: 1 } },
      { id: "m1_fabric", label: "Fabric", visual: { kind: "icon", icon: "fabric" }, riasec: { A: 2, S: 1 } },
      { id: "m1_stone",  label: "Stone",  visual: { kind: "icon", icon: "stone" }, riasec: { R: 2, I: 1 } },
    ],
  },
  {
    ...
    options: [
      { id: "v1_sprint", label: "A sprint",     visual: { kind: "icon", icon: "flag" }, riasec: { E: 2, R: 1 } },
      { id: "v1_climb",  label: "A slow climb", visual: { kind: "icon", icon: "climb" }, riasec: { R: 2, E: 1 } },
      { id: "v1_dance",  label: "A dance",      visual: { kind: "icon", icon: "dance" }, riasec: { A: 2, S: 1 } },
      { id: "v1_dive",   label: "A deep dive",  visual: { kind: "icon", icon: "dive" }, riasec: { I: 3 } },
      { id: "v1_march",  label: "A steady march", visual: { kind: "icon", icon: "boot" }, riasec: { C: 2, R: 1 } },
