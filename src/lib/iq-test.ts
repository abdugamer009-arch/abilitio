...
export const IQ_QUESTIONS: IQQuestion[] = [
  {
    id: 1,
    category: "logical",
    prompt: "A white dot moves two places anti-clockwise at each stage. A black dot moves one place clockwise at each stage. The white dot starts at the bottom-left corner and the black dot starts at the top-right corner of a square. After how many stages will both dots be in the same corner?",
  ...
  },
  {
    id: 4,
    category: "verbal",
    prompt: "Which two words are most OPPOSITE in meaning?\nimaginary, realistic, illegible, impracticable, radical, embellished",
    options: ["imaginary / radical", "realistic / impracticable", "illegible / embellished", "radical / embellished"],
    correct: 1,
  },
  {
    id: 5,
    category: "numerical",
    prompt: "A number grid has a pattern in each row and column. The four missing values (top-right of each row) are:",
  ...
  },
  {
    id: 7,
    category: "verbal",
    prompt: "Identify one word from each bracket that forms a connection with the word in capitals:\nRESTRAIN (suppress / deny / conceal)\nWITHHOLD (curb / reserve / conceal)",
  ...
  },
  {
    id: 8,
    category: "spatial",
    prompt: "A dot moves around a shape two places clockwise at each stage and alternates between black and white. Which option correctly shows the next figure in the sequence?",
  ...
  },
  {
    id: 9,
    category: "verbal",
    prompt: "Spell out a 12-letter word by moving from letter to adjacent letter (horizontally and vertically, not diagonally) in the grid:\nC A _ I _ C L O D N E E _ _ _\nWhat is the word?",
  ...
  },
  {
    id: 13,
    category: "logical",
    prompt: "Two triangles of numbers follow a rule. Triangle 1: corners 7, 3, 5 / sides 9, 2, 6 / centre 4, 2, 1. Triangle 2: corners 13, 13, 6 / sides 19, ?, 5 / centre 11.\nWhat number replaces the question mark?",
  ...
  },
  {
    id: 14,
    category: "spatial",
    prompt: "Five shapes (A–E) are shown. C is the same as E with large/small shapes swapped; B is the same as D. Which shape is the odd one out?",
    options: ["A", "B", "C", "D", "E"],
    correct: 0,
  },
  {
  ...
  },
  {
    id: 17,
    category: "verbal",
    prompt: "Which word in brackets is most OPPOSITE in meaning to MITIGATE?\n(augment, palliate, appreciate, trust, destroy)",
  ...
  },
  {
    id: 18,
    category: "spatial",
    prompt: "A shape is shown. Which of options A–E is exactly identical to it (allowing for rotation, but not reflection)?",
  ...
  },
  {
    id: 23,
    category: "verbal",
    prompt: "Which word in brackets is closest in meaning to HABITUATED?\n(constant, accustomed, colonized, commonplace, energetic)",
  ...
  },
  {
    id: 24,
    category: "spatial",
    prompt: "A 3×3 grid of tiles has one missing. Looking across each row, a black dot is added. Looking down each column, a circle is added. Which tile completes the grid?",
    options: ["A", "B", "C", "D"],
    correct: 2,
  },
  {
  ...
  },
  {
    id: 27,
    category: "spatial",
    prompt: "A shape series: the number of sides reduces by 1 at each stage; the number of dots increases by 1 and the dots turn from white to black. Which option correctly shows the next shape?",
    options: ["A", "B", "C", "D"],
    correct: 0,
  },
  {
  ...
  },
  {
    id: 29,
    category: "spatial",
    prompt: "A sequence of rotating arcs: the large arc rotates 90° clockwise each stage; the middle arc rotates 90° anti-clockwise; the inner arc rotates 90° anti-clockwise. Which option (A–F) comes next?",
    options: ["A", "B", "C", "D", "E", "F"],
    correct: 5,
  },
  {
    id: 30,
    category: "logical",
    prompt: "Numbers in the outer ring of a circle are the DIFFERENCE of the two inner numbers adjacent to them (anti-clockwise). Given: 9−4=5, 7−5=2, 8−1=7. What number replaces the question mark?",
    options: ["3", "4", "5", "6"],
    correct: 2,
  },
  {
    id: 31,
    category: "logical",
    prompt: "Switch A toggles lights 1 and 2. Switch B toggles lights 2 and 4. Switch C toggles lights 1 and 3. Switches A, C, B are thrown in order.\nStart: lights 1●, 2○, 3●, 4○\nResult: lights 1●, 2●, 3○, 4○\nWhich switch must be faulty?",
  ...
  },
  {
    id: 32,
    category: "spatial",
    prompt: "Five shapes (A–E) are shown. Four of them are the same figure in different rotations. Which is the odd one out?",
    options: ["A", "B", "C", "D", "E"],
    correct: 1,
  },
  {
    id: 33,
    category: "numerical",
    prompt: "Three overlapping circles contain numbers. Left circle: 3.5, 5, 1.5, 4.5. Centre overlap: 7.5, 11, 3.5, ?. Right circle: 2, 8.5, 3.\nRule: each centre value = corresponding left value + corresponding right value.\nWhat replaces the question mark?",
  ...
  },
  {
    id: 34,
    category: "spatial",
    prompt: "A 3×3 grid is formed by a rule: only symbols that appear in the same cell position in both the first and second squares are carried forward; circles become squares and squares become circles. Which tile (A–E) completes the grid?",
    options: ["A", "B", "C", "D", "E"],
    correct: 4,
  },
  {
    id: 35,
    category: "verbal",
    prompt: "Start at one of the four corner letters and spiral clockwise around the perimeter, finishing at the centre letter, to spell a 9-letter word.\nLetters available: N A R N C O T _\nWhat is the word?",
  ...
  },
  {
    id: 37,
    category: "spatial",
    prompt: "A flat net (unfolded cube) is shown. Which of the options A–E can be produced when the net is folded into a cube?",
    options: ["A", "B", "C", "D", "E"],
    correct: 0,
  },
  {
    id: 38,
    category: "numerical",
    prompt: "Joe has one and a half times as many as Mo. Mo has one and a half times as many as Flo. Altogether they have 76. How many does Joe have?",
    options: ["24", "30", "36", "40"],
    correct: 2,
  },
  {
  ...
  },
  {
    id: 40,
    category: "numerical",
    prompt: "What number replaces the question mark in this grid?\n 1   3   7  13\n 4   6  10  16\n 9  11  15  21\n16  18  22   ?\n(Across: add 2, 4, 6. Down: add 3, 5, 7.)",
    options: ["24", "26", "28", "30"],
    correct: 2,
  },
];
