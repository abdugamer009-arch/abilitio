      ...
      <section className="px-6 pt-20 pb-12">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link to="/school/register" className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-all hover:glow-purple">
      ...
      <section className="px-6 pb-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {PLANS.map((p) => (
              <div key={p.name} className={`glass rounded-3xl p-7 ${p.highlight ? "ring-1 ring-primary/40 shadow-[0_20px_60px_-30px_var(--glow)]" : ""}`}>
